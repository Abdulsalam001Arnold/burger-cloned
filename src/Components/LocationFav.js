...
export default function LocationFav({ displayFav }) {
  ...
  return (
    <div className='bg-inherit w-full h-[50%] mt-[40px] m-auto'>
        <div className=''>
          {
            displayFav.nearby ? <Link to='' className='flex flex-col items-center list-none h-[80px]'>
        ...
        <div className='flex flex-col items-center divide-[rgb(43,2,0)]'>
          <h2 className='text-[rgb(43,2,0)] font-extrabold text-[17px] mt-5'>Sign In to Save Favorites</h2>
          ...
          <button className='bg-[rgb(214,35,0)] w-[200px] h-12 rounded-[20px] mt-[15px] text-white font-bold text-[15px]'>Share Location</button>
        </div>
     </Link>  :
            ...
            <div className='flex flex-col items-center divide-[rgb(43,2,0)]'>
          <h2 className='text-[rgb(43,2,0)] font-extrabold text-[17px] mt-5'>Sign In to See Recent Locations</h2>
